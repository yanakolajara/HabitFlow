...
function Stats() {
  ...
  function displayStats() {
    return stats.map((x) => {
      ...
      if (Number(x.completion) === 1) {
        completionStatus = '#70ff6d';
      } else if (Number(x.completion) === 2) {
        completionStatus = '#edff7a';
      } else if (Number(x.completion) === 3) {
        completionStatus = '#ff6d6d';
      }
      return (
